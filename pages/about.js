...
const about = () => {
    ...
    <Head>
     ...
     <meta name="Teknologiat" content="Teknologiat" />
        ...
        <div>
        <Image src="/wordpress_logo.jpg" alt="wp_logo" width={470} height={270}/>
        </div>
        <div>
        ...
        enemmän hallintaa ja nopeutta.</p>
            ...
            <Image src="/next-js_logo.png" alt="nextjs_logo" width={240} height={240}/>
            </div>
            </div>
        <h3>Wordpress</h3>
        <p className={styles.about }>
        ...
        <div>
        <Image src="/wordpress_logo.jpg" alt="react_logo"  width={470} height={270}/>
        </div>
        <div>
